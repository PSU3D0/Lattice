//! Shared OpenDAL helpers used across the blob and kv capability modules.
//!
//! This module centralises feature flags, operator factories, and error
//! translation so the capability adapters (blob, kv, queue, etc.) can focus on
//! domain behaviour instead of wiring OpenDAL plumbing.
...
/// Error translation utilities used by the capability modules.
pub mod error;
...
///
/// Capability modules can implement this trait directly or wrap the provided
