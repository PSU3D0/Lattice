...
//!
//! Exposes [`OpendalBlobStore`], an implementation of
//! [`capabilities::blob::BlobStore`] that stores objects via OpenDAL operators.
//! Builders consume any [`crate::OperatorFactory`] implementation, ensuring the
//! blob and kv surfaces share feature matrices, layer wiring, and error
//! translation logic.

use crate::core::{OpendalError, OpendalResult, OperatorFactory};
use capabilities::{
    Capability,
...
mod tests {
    use super::*;
    use crate::core::SchemeOperatorFactory;
