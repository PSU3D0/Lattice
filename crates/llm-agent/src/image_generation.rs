...
pub trait ImageGenerationModelDyn: WasmCompatSend + WasmCompatSync {
    fn image_generation(
        &self,
        request: ImageGenerationRequest,
    ) -> WasmBoxedFuture<'_, Result<ImageGenerationResponse<()>, ImageGenerationError>>;
...
impl ImageGenerationModel for ImageGenerationModelHandle<'_> {
    ...
    fn make(_client: &Self::Client, _model: impl Into<String>) -> Self {
        panic!("'ImageGenerationModel::make' should not be called on 'ImageGenerationModelHandle'")
    }
