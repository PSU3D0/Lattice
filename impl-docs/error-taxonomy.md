...
- **Runtime resume failures** — `DAG-CKPT-006`..`DAG-CKPT-010`. Missing checkpoints, lease conflicts, corrupted state, version mismatches, or pinned-bundle mismatch/unavailability during resume.
